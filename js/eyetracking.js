          ...
          columns: [
              ...
              { title: "회차 URL", data: "url"},
              {
                  ...
                  render: function(data, type, row) {
                      return '<button data-id="' + row.id + '" class="btn btn-info btn-icon-split statistics"><span class="text">아이트래킹 분석</span></button>';
                  }
              }
          ]
        });
...
function statistics(){
  ...
  window.location.href = 'eyetrackingStatistics.html';
}
